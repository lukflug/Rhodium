...
public class ClickGUIModule extends Module {
	...
	@Override
	public ColorSetting registerColor(String name, String description, boolean rainbowEnabled, boolean alphaEnabled, Color value, boolean rainbow) {
		return super.registerColor(name, description, rainbowEnabled, alphaEnabled, value, rainbow);
	}
}
